...
async function getProductById(id) {
    ...
    const res = await fetch(`https://next-store-server-alpha.vercel.app/products/${id}`);
...
const ProductDetailsPage = async ({ params }) => {
    ...
    return (
        <div className="max-w-screen-xl mx-auto px-6 py-10">
            <Link href="/products" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Back to products
            </Link>
